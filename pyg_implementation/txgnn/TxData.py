...
from .utils import preprocess_kg, create_split, process_disease_area_split, create_pyg_graph, evaluate_graph_construct, convert2str, data_download_wrapper
...
class TxData:
    ...
    def prepare_split(self, split = 'complex_disease',
        ...
        # create pyg graph
        g = create_pyg_graph(df_train, df)
